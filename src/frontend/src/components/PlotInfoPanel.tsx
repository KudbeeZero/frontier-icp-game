...
function ensureKeyframes() {
  ...
  el.textContent = [
    ...
    "  0%,100% { box-shadow: 0 0 18px rgba(0,255,204,0.45),0 0 40px rgba(0,255,204,0.18),inset 0 0 20px rgba(0,255,204,0.04); }",
    "  50%     { box-shadow: 0 0 28px rgba(0,188,212,0.6),0 0 60px rgba(0,188,212,0.25),inset 0 0 30px rgba(0,188,212,0.07); }",
    "}",
